...
../build-$(ConfigurationName)/My2DGameEngine/Texture.cpp$(ObjectSuffix): Texture.cpp ../build-$(ConfigurationName)/My2DGameEngine/Texture.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/Volumes/Data/My2DGameEngine/My2DGameEngine/Texture.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Texture.cpp$(ObjectSuffix) $(IncludePath)
../build-$(ConfigurationName)/My2DGameEngine/Texture.cpp$(DependSuffix): Texture.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT../build-$(ConfigurationName)/My2DGameEngine/Texture.cpp$(ObjectSuffix) -MF../build-$(ConfigurationName)/My2DGameEngine/Texture.cpp$(DependSuffix) -MM Texture.cpp

../build-$(ConfigurationName)/My2DGameEngine/Texture.cpp$(PreprocessSuffix): Texture.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) ../build-$(ConfigurationName)/My2DGameEngine/Texture.cpp$(PreprocessSuffix) Texture.cpp
